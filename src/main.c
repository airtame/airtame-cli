...
enum Function {NONE, CLOSE_STREAMER, INIT_STREAMER, CONNECT_IP, DISCONNECT_IP, CONNECT, DISCONNECT, SCAN, LISTEN, AVMODE, AVBUFFER, FRAMERATE, QUALITY, SHELL};
...
void ssdp_main_thread(void *user) {
    ...
    ssdp_init(&ssdp, ssdp_notify_callback, ssdp_resp_callback);
    ssdp.user = 0;
